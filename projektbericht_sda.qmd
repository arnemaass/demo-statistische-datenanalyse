...
# Kovarianzmatrix
kable(cov(select_if(df, is.numeric)),digits = 3, format = "latex", caption= "Covarianzmatrix") %>% kable_styling(latex_options = "scale_down")
